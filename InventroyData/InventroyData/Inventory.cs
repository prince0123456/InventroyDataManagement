...
// <creator name="Prince Gupta"/>
// -----------------------------------------------------------------------
namespace InventroyData
{
    ...
    public class Inventory
    {
        ...
        public void JsonDeserilaize()
        {
            ...
            InventoryUtility utility = JsonConvert.DeserializeObject<InventoryUtility>(File.ReadAllText(@"F:\BL_.net278\Demo\InventroyDataManagement\InventroyData\InventroyData\json.json"));
            // options
                ...
                case 2:
                    ...
                    switch (optionOne)
                    {
                        case 1:
                            ...
                            File.WriteAllText(@"F:\BL_.net278\Demo\InventroyDataManagement\InventroyData\InventroyData\json.json", JsonConvert.SerializeObject(utility));
                            break;
                        case 2:
                            // add records to inventory
